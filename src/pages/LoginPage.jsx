...
import { LogIn, Mail, Lock, ArrowRight, Loader, ShoppingBag, ShieldCheck, Zap } from "lucide-react";
        ...
        <div className="hidden lg:flex lg:w-5/12 relative overflow-hidden bg-black flex-col justify-between p-8">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold bg-clip-text text-transparent bg-linear-to-r from-white to-slate-400">DashCart</span>
            </div>
          </div>
          ...
          <div className="relative z-10 max-w-md">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1, delay: 0.2 }}>
              ...
              <p className="mt-3 text-base text-slate-300">
                 Access your personalized dashboard, manage your lifestyle, and discover exactly what you need.
              </p>
